...
export type StandardResearch = {
  ...
  /** 参照先URLは client/src/data/links.json で一括管理し、ここではそのリンクIDだけを持ちます。 */
  referenceLinks: string[];
};

type StandardInput = { id: string; category: string };

const fatigueReferenceLinks = ["ref-nist-fatigue"];

const categoryResearch: Record<string, StandardResearch> = {
  "軸力制御": {
    ...
    referenceLinks: fatigueReferenceLinks,
  },
  "低サイクル": {
  ...
  "熱機械疲労": {
    ...
    referenceLinks: ["ref-nasa-tmf", ...fatigueReferenceLinks],
  },
  "回転曲げ": {
  ...
  "き裂進展": {
    ...
    referenceLinks: ["official-astm-e647", ...fatigueReferenceLinks],
  },
  "破壊靭性": {
    ...
    referenceLinks: ["official-astm-e1820", "official-iso-12135"],
  },
  "複合負荷": {
    ...
    referenceLinks: ["official-astm-e2207"],
  },
  "動的粘弾性": {
  ...
  "動的弾性率": {
    ...
    referenceLinks: ["official-astm-e1876"],
  },
  "制振・減衰": {
    ...
    referenceLinks: ["official-astm-e756"],
  },
  "試験系検証": {
    ...
    referenceLinks: ["official-astm-e467"],
  },
  "データ整理": {
    ...
    referenceLinks: ["official-astm-e468"],
  },
};
